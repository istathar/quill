...
public final class LeaderSegment extends Segment
{
    public LeaderSegment(Extract entire) {
        super(entire);
    }

    public LeaderSegment(Extract entire, int offset, int removed, int inserted) {
